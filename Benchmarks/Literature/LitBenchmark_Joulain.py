...
omega_values = np.logspace(14, 17, 501)
...
# Plot LDOS
plt.figure(dpi=400)
plt.loglog(omega_values, rho[:, 0], 'r-', label=r"z = 1 nm")  # Electric LDOS
plt.loglog(omega_values, rho[:, 1], 'b--', label=r"z = 10 nm")  # Magnetic LDOS
plt.loglog(omega_values, rho[:, 2], 'g--', label=r"z = 100 nm")  # Total LDOS
plt.loglog(omega_values, rho[:, 3], 'k--', label=r"z = 1000 nm")  # Total LDOS
